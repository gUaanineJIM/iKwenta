...
@section('content')
    ...
    <section class="owner-section owner-detail-page" data-customer-detail-page hidden aria-label="Customer account details">
        <a class="btn btn-text owner-detail-page__back" href="{{ route('owner.customers') }}">
    ...
    <div class="modal owner-modal" id="add-customer-modal" aria-hidden="true">
        ...
        <div class="modal-dialog" role="dialog" aria-modal="true" aria-labelledby="customer-modal-title">
            ...
            <form class="owner-modal__form" data-customer-form enctype="multipart/form-data">
                ...
                <label class="field-label">Description / note <span class="field-hint">Optional</span><textarea class="form-input customer-description" name="description" rows="3" maxlength="5000" placeholder="Anything worth remembering about this customer…"></textarea></label>
